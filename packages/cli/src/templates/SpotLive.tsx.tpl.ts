export function getSpotLiveTemplate(_alias: string): string {
  // The alias parameter is reserved for future use (e.g., importing shared utils).
  // The component itself has no internal alias-dependent imports.
  return `"use client";
